...
template <class T>
LP_second_order<T>::LP_second_order( const float Te, const float w0, const float Q, const T* const x_ptr, T* const y_ptr ) :
                    _Te( Te ), _w0( w0 ), _Q( Q ), _x_ptr( x_ptr ), _y_ptr( y_ptr ), _y_k0( 0 ), _y_k1( 0 ), _y_k2( 0 ), _x_k1( 0 ), _x_k2( 0 )
{
	if ( _y_ptr == nullptr )
		_y_ptr = &_y_k0;
}
...
template <class T>
LP_second_order_bilinear<T>::LP_second_order_bilinear( const float Te, const float w0, const float Q, const T* const x_ptr, T* const y_ptr ) :
...
template <class T>
LP_first_order<T>::LP_first_order( const float Te, const float wc, const T* const x_ptr, T* const y_ptr ) :
                   _Te( Te ), _wc( wc ), _x_ptr( x_ptr ), _y_ptr( y_ptr ), _y_k0( 0 ), _y_k1( 0 ), _x_k1( 0 )
{
	if ( _y_ptr == nullptr )
		_y_ptr = &_y_k0;
}
...
template <class T>
LP_first_order_bilinear<T>::LP_first_order_bilinear( const float Te, const float wc, const T* const x_ptr, T* const y_ptr ) :
...
template <class T>
LP_first_order_homographic<T>::LP_first_order_homographic( const float Te, const float wc, const T* const x_ptr, T* const y_ptr ) :
                               LP_first_order<T>( Te, wc, x_ptr, y_ptr )
{
...
template <class T>
LP_first_order_step_matching<T>::LP_first_order_step_matching( const float Te, const float wc, const T* const x_ptr, T* const y_ptr ) :
                                 LP_first_order<T>( Te, wc, x_ptr, y_ptr )
{
...
template <class T>
LP_first_order_impulse_matching<T>::LP_first_order_impulse_matching( const float Te, const float wc, const T* const x_ptr, T* const y_ptr ) :
                                    LP_first_order<T>( Te, wc, x_ptr, y_ptr )
{
	double ewt = exp( -wc*Te );
	this->_Cy1 = ewt;
